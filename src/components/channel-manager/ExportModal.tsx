          ...
          <table className="w-full min-w-[980px] table-fixed border-collapse">
            ...
            <thead>
              <tr className="border-b border-[#e9eaeb] bg-[#fafafa]">
                ...
                <th className="sticky left-12 z-30 pl-0 pr-6 py-3 text-left text-[12px] leading-[18px] font-semibold text-[#414651] bg-[#fafafa]">
            ...
            <tbody>
              {filteredListings.map((listing) => {
                ...
                <tr key={listing.id} className="group h-[72px] border-b border-[#e9eaeb]">
                  <td className="sticky left-0 z-20 w-12 px-4 py-3 bg-white group-hover:bg-[#fcfcfd] transition-[background-color] duration-[120ms] ease-[var(--motion-ease-default)]">
                    <Checkbox
                  ...
                  <td className="sticky left-12 z-20 pl-0 pr-6 py-3 bg-white group-hover:bg-[#fcfcfd] transition-[background-color] duration-[120ms] ease-[var(--motion-ease-default)]">
                    <span className="text-[14px] leading-5 font-medium text-[#181d27]">{listing.name}</span>
                  </td>
                  <td className="bg-white px-6 py-3 text-[14px] leading-5 text-[#535862] group-hover:bg-[#fcfcfd] transition-[background-color] duration-[120ms] ease-[var(--motion-ease-default)]">{hostawayId}</td>
                  <td className="bg-white px-6 py-3 group-hover:bg-[#fcfcfd] transition-[background-color] duration-[120ms] ease-[var(--motion-ease-default)]">
                    {isMissing ? (
